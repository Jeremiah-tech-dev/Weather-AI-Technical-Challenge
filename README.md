...
FarmPulse is a real-time farm monitoring dashboard built on top of the [Weather-AI API](https://weather-ai.co/docs). It gives agronomists and farmers a single, unified view of all their farms — live weather conditions, 7-day forecasts, and hourly breakdowns.
...
| API | Weather-AI REST API | Provides live weather, forecasts, and usage data |
