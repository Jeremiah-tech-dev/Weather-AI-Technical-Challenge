      ...
      {activeModal === 'Solutions' && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-24" onClick={close}>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { icon: '🌦️', title: 'Hyperlocal Weather', desc: 'Live temperature, humidity, wind speed and conditions pulled directly from the Weather-AI /v1/current API — pinned to every farm.' },
                { icon: '📅', title: '7-Day Forecast', desc: 'Daily high/low temperatures and rain probability visualised as bar charts, powered by the Weather-AI /v1/daily API.' },
                { icon: '⏱️', title: 'Hourly Breakdown', desc: 'Hour-by-hour temperature and rain probability for the current day via the Weather-AI /v1/hourly API.' },
                { icon: '⚠️', title: 'AI Risk Alerts', desc: 'Agronomic risk flags — high, medium and low severity — generated by Weather-AI /v1/insights and filterable per farm.' },
              ].map(s => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={close}>
          ...
          >
            ...
            <div className="space-y-3">
              {[
                { icon: '📡', title: 'Live Weather Monitoring', desc: 'Real-time temp, humidity, wind speed and UV per farm — fetched live from the Weather-AI API every 5 minutes.' },
                { icon: '📊', title: 'Forecast Dashboard', desc: '7-day bar charts and hourly line charts built on live Weather-AI forecast data, so you always know what is coming.' },
                { icon: '🔔', title: 'AI Risk Alerts', desc: 'Weather-AI analyses conditions per farm and raises high, medium or low severity agronomic risk flags you can act on instantly.' },
                { icon: '💰', title: 'API Budget Tracker', desc: 'Live usage bar showing your Weather-AI API calls consumed vs. your monthly limit — with colour-coded warnings.' },
              ].map(s => (
