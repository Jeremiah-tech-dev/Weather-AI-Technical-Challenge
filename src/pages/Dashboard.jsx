  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="relative rounded-3xl p-8 w-full max-w-sm mx-4 text-center"
        ...
        {!stage.msg && <p className="text-white/30 text-xs">Resets monthly · Powered by Weather-AI</p>}
      </div>
    </div>
  )
}

function ApiUsageBar({ used, limit, onOpen }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
      <p className="text-white/70 text-xs font-semibold uppercase tracking-widest mb-3">🤖 AI Quota</p>
